<template>
    <div style="width:100%; height:100%">
        <center>
         <div style="width:30%; height:60%; background-color:#514545 ; border-radius:10%; color:white" ><br>
         <h2><p> Mr :{{this.$store.state.pseudo}}</p></h2> 
         <h2><p> Votre score est  : {{this.$store.state.score}}</p></h2> 
         <h2><p> Temps écoulé  :{{tm}} min</p></h2> 
         <br><br>
         </div><br>
         </center>
         <center>
